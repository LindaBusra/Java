...
public class Exceptions02 {
    public static void main(String[] args) {
        ...
        System.out.println(getElementFromStringArray(arr, 6));  //Index 6 out of bounds for length 5
        System.out.println(getElementFromStringArray(arr, -3));
    ...
    public static String getElementFromStringArray(String [] arr, int idx){
        try {
            ...
            return arr[arr.length-1]; //for example in question: if the index not exist give me the last element
        }
    }
}
