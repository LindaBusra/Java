...
public class Animal {
    ...
    /*
    1)Polymorphism has two parts;  (multiple-form)
    ...
    3)In "Method Overriding", we do not touch "Method Signature" I mean we do not touch "Method Name"
      and "Method Parameters". We touch just the method body.
   ...
   7)If a method in the parent class is "private" it cannot be overridden because it can not be uses in another class
 ...
 */
    ...
    public int move(){
        return 100;     //if you do not have "Covariant Data Types" return types must be the same
