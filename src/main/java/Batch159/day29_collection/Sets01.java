...
public class Sets01 {
  ...
  There are 3 sets
        i)HashSet:
         ...
         iii)TreeSet:
             TreeSet puts the elements in "natural order" (alphabetical order and descending order)
        ...
        LinkedHashSet<Integer> lhs = new LinkedHashSet<>();     //add elements in insertion order
        lhs.add(12);
        lhs.add(5);
        lhs.add(19);
        lhs.add(15);
        ...
        lhs.retainAll(mhs);  //common elements does not remove from lhs, the other elements removes from lhs
        ...
        HashSet<String> hs = new HashSet<>();           //add elements randomly
        hs.add("Germany");
        hs.add("Albania");
        hs.add("Belgium");
        hs.add("USA");
        ...
        hs.add("Turkey");
//        hs.add(null); //it accept null as element
        System.out.println(hs);     //[USA, Turkey, Belgium, UK, Germany, Albania]-->most of the times null is the fist element


        long t2 = System.nanoTime();

        TreeSet<String> ts = new TreeSet<>();   //add the elements in natural order
        ts.add("Germany");
        ts.add("Albania");
        ts.add("Belgium");
        ts.add("USA");
...
/*
    ...
    So you will have "unique elements" in "natural order" and you will not be slow.         */
        ...
        System.out.println(t2-t1);  //59200 nano
        System.out.println(t3-t2);  //142000 nano
        System.out.println(t4-t3);  //99700 nano
