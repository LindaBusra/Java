...
public class ExceptionAndReadingMethodAndReadLineMethod01 {
    /*
    ...
    public static void main(String[] args) {
        try {
            FileInputStream fis = new FileInputStream("src\\main\\java\\JavaLessons\\day27_exceptions\\File01.txt");
            ...
            while ((i= fis.read()) != -1){ //while typing read() gives CTE bec. java is worried if there is no file or file is deleted. so we choose more
                ...
                System.out.print((char)i); //telling java to check the typed char.s if their ascii value is greater than -1 java will print each char.
