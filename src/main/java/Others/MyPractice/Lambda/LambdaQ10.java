...
public class LambdaQ10 {
    ...
    // 1)Use Functional Programming.  //Create a method to print list elements which are starting with "A" in uppercases
    ...
    // 2)Use Functional Programming. //Create a method to print list elements which are starting with "A" or ending with "o" in lowercases
   ...
   // 3)Use Functional Programming. //Create a method to print the elements in uppercases after ordering according to their lengths
    ...
    // 4)Use "Functional Programming". Create a method to print the elements if the length is greater than 5
...
//        }
    ...
    public static void getCharAndLength(List<String> list) {
        ...
        list.stream().
                sorted(Comparator.comparing(String::length)).map(t -> t + " : " + t.length()).  //or forEach(t-> System.out.println(t + ":" + t.length()))
                forEach(Utils::printInSameLineWithSpace);
