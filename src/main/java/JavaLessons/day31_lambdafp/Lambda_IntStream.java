...
public class Lambda_IntStream {
    public static void main(String[] args) {
        ...
        System.out.println(calculateFactorial01(5));    //120
        System.out.println(calculateFactorial02(-11));  //Please enter positive integers for factorial operations

        System.out.println(sumOfIntsInGivenRange(-2, -4)); //-2448
    ...
    public static int getSumFromSevenToHundred01(){
        ...
        //1.way:
        return IntStream.range(7, 101).reduce(0, Math::addExact);   //101 is not inclusive, initial value=0
    ...
    public static int calculateFactorial01(int x){
        ...
        System.out.println("Please enter positive integers for factorial operations");  //if I dont write this part, it gives me 1!!!
        return 0;
    }


    //2:way (without return 0)   We use Object like return type
    public static Object calculateFactorial02(int x){       //Object data type covers integer and strings
    ...
    public static int sumOfIntsInGivenRange(int a, int b){ //if user gives -2, -4 it does not works. (a <b it must be like that actually)

        int x=0; //we make swapping
        if(a>b){
            x=a;
            a=b;
            b=x;
