...
import java.util.stream.Collectors;
    ...
    public class Lambda_Courses {
        ...
        public static void main(String[] args) {
            ...
            Courses courseTurkishDay = new Courses("Summer", "Turkish Day", 97, 128);   //or we can assign them one by one: String season=new Courses();--> season = "Summer";
            ...
            System.out.println(coursesList);  //all list
        ...
        public static boolean checkAvgScoresToBeGreaterThanGivenNum(List<Courses> list, double avgScore){
            ...
            return list.stream().allMatch(t-> t.getAverageScore()> avgScore);   //list.stream() :get my list
...
//        public static List<Courses> sortCourseWithAverageScoreInAscendingPrintJustGivenOne(List<Courses> list, int num){
//
//
//
//        }
