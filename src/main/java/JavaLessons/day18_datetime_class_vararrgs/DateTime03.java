...
public class DateTime03 {
    public static void main(String[] args) {
        ...
        System.out.println("After 200 days, dato is: " + LocalDate.now().plusDays(200));//2022-09-17
        System.out.println("After 25 months dato is: "+ LocalDate.now().plusMonths(25));// 2024-04-01

        //How to get past dates
        System.out.println("Before 7 weeks dato was: " + LocalDate.now().minusWeeks(7));//2022-01-11
