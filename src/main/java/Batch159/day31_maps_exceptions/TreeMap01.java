...
public class TreeMap01 {
        ...
        3)TreeMaps are not "thread-safe" and are not "synchronized". If you need multi-thread, you have just a single option, it is HashTable
   ...
   */
    ...
    public static void main(String[] args) {
        ...
        //for make it faster I created HashMap, after that I converted it to TreeMap
        ...
        System.out.println(t2-t1);      //309100 so slow
        System.out.println(t3-t2);      //61200
        System.out.println(t4-t3);      //37399
