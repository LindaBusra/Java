...
public class E06 {
    ...
    public static void main(String[] args) {
        ...
        //doCombo("5612", 2);//2806
        //doCombo(null, 2);//NullPointerException: str.length(); will throw NullPointerException, execution will be stopped in line 21
        //doCombo("", 2);//NumberFormatException
        //doCombo("12a", 2);//NumberFormatException : Integer.valueOf(str); will throw NumberFormatException, execution will be stopped in line 24
        //doCombo("420", 0);//ArithmeticException : intStr/num; will throw ArithmeticException, execution will be stopped in line 27
    ...
    public static void doCombo(String str, int num){
        ...
        }catch(NullPointerException e){   //NullPointerException-->don't have any message
    ...
    public static void doCombo2(String str, int num){
        ...
        try {
            ...
            int result = intStr / num;
            System.out.println(result);
        }catch(Exception e){                  //There are parent / child relationship between the exception and AE, NFE, NPE. And Java send the right message
            // that is convenient for the situation
