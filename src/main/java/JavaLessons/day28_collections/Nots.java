...
HashSet:
1) It consists of unique elements, an element can be used only once in Sets. no duplicate elements
2) If you want to add an element back to the HashSet,the old one is deleted and the new one is overwritten.
