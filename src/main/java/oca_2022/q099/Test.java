...
//		e1.printDetails();
		...
		/*
		 ...
		 D) Compilation fails in the Test1 class
		 
		 E) Both the Employee class and the Test1 class fail to compile
		 ...
		 Test1 class da e1 object olusturulurken default constructor kullanilmis
