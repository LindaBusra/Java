...
public class HondaRunner {
    ...
    public static void main(String[] args) {
        ...
        Honda myHonda = new Honda();    //for call concrete method we have to create object from child class
        myHonda.eco();


        //We can call the method which is created static, directly by using Interface name
        Brake.secure();
    }
}
