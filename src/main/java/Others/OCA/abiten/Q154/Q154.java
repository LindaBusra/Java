package Others.OCA.abiten.Q154;
...
public class Q154 {
    ...
    public static void main(String[] args) {
        ...
        String[] myArray;
        try{
            while(true){                  //infinite loop. It results error in main because of memory. . //Exception in thread "main" java.lang.OutOfMemoryError: Java heap space
