...
public class LambdaQ7 {
    ...
    public static void main(String[] args) {
        ...
        List<String> l = new ArrayList<>();         //I can add elemenet with this way too: List<String> l = Arrays.asList(arr);  -->String arr[] = {"Ali", "Mark", "Amanda", };
    ...
    public static void printInUpperCase02(List<String> list){       //It writes like array, with "," between words
    ...
    public static void printAllElementsByTheirLengthAndFirstInitialChars(List<String> list) {
     ...
     list.stream().distinct().sorted(Comparator.comparing(String::length).thenComparing(Utils::getFirstChar)).
