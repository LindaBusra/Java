package Others.MyPractice.Exercises;
...
public class Exercises05 {
    ...
    /*3
     ...
     no4LetterWords( {"Train", "Boat", "Vehicle"} )  ->  ["Train", "Vehicle"]
    ...
    ** INTERVIEW QUESTION **
    ...
    public List<String> fizzBuzzList(Integer[] integerArray) {
        ...
        for (int num: integerArray) {
            if (num % 3 == 0) {
                if (num % 5 == 0) result.add("FizzBuzz");
                else result.add("Fizz");
            }
            else if (num % 5 == 0) result.add("Buzz");
            else result.add(Integer.toString(num));
        }
        return result;
    }
    ...
    public List<String> distinctValues(List<String> stringList) {
        ...
        for (String word: stringList) {
            if (!distinct.contains(word)) distinct.add(word);
        }
        return distinct;
    }
    ...
    public List<Integer> interleaveLists(List<Integer> listOne, List<Integer> listTwo) {
        List<Integer> weave = new ArrayList<Integer>();
        while(!listOne.isEmpty() && !listTwo.isEmpty()) {
            weave.add(listOne.remove(0));
            weave.add(listTwo.remove(0));
        }
    ...
    public List<Integer> boardingGate(List<Integer> seatNumberList) {
        ...
        for (int num: seatNumberList) {
            if (num >= 1 && num <= 10) q1.offer(num);
            else if (num >= 11 && num <= 20) q2.offer(num);
            else if (num >= 21 && num <= 30) q3.offer(num);
        }

        while (!q1.isEmpty()) result.add(q1.poll());
        while (!q2.isEmpty()) result.add(q2.poll());
        while (!q3.isEmpty()) result.add(q3.poll());
