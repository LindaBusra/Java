...
/*
    ...
    5)Can you update the encapsulation data if you need?
      Yes, I can update the data by using "set method"
    6)By using set methods, we are able to work with less objects.
...
public class Student {
    ...
    private String stdId = "TH2023FL";   //variable is not accessible. by using get method it can be accessible
...
//    }
   ...
   //2.way-->right click-->generate-->getter-->select the value
    public String getStdId() {
        return stdId;
    }
    ...
    //every time return type of setter will be void
    //1.way: Typed it manually
//    public void setStdId(String stdId){     //method does not return any data. This method does just change this value-->"TH2023FL"
//        this.stdId = stdId;
//    }

    //2.way-->right click-->generate-->setter-->select the value
