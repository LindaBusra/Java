...
public enum Enum_UsStates {
    

    /*
        Enum is a storage to store "constant data" you need for your application
    */
    ALABAMA("Alabama", "AL", "Montgomery"),     //name of city, abbreviation. capital city
    ...
    private final String abbreviation;      //I have to assign value, because it is final
    private final String capital;


    Enum_UsStates(String stateName, String abbreviation, String capital) {
