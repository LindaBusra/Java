...
public class Wrapper01 {
    ...
    public static void main(String[] args) {
        ...
        Byte stdAge = 13;// When you put "." after "stdAge" you will see many methods. Wrapper classes use more memory.
        ...
        int num = 25;
        Integer wrapperNum = num; //Java changes data type of "num" automatically to Integer
