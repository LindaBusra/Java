...
public class MethodCreation01 {
    ...
    public static void main(String[] args) {
        ...
        //Actual values used in method call are called "Argument"s   --> 45, 57
        //Variables created in method parenthesis are called "Parameter"s  --> int a, int b
        System.out.println(getSurfaceAreaOfRectangularPrism(3.2, 5, 4));// 97.6

        printNameWithExclamationMark("Tom");

        // Every method I want to use in main method must be static. Because main method is static.

    }

    //Add to numbers
    public static int add(int a, int b){    //Values inside the parenthesis are parameters
        return a+b;
    }
    ...
    public static double getPerimeterOfRectangle(double a, double b){       //Values inside the parenthesis are parameters
        return 2*a+2*b;
    }
